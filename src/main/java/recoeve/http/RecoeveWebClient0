...
public class RecoeveWebClient0 extends AbstractVerticle {
	...
	public static final long TIMEOUT_DRIVER = 600000L;
	...
	public RecoeveWebClient0(Vertx vertx, Context context, RecoeveDB db) {
		this.vertx = vertx;
	...
	public static void main(String... args) {
		try {
			...
			RecoeveWebClient0 recoeveWebClient = new RecoeveWebClient0(vertx, vertx.getOrCreateContext(), new RecoeveDB(vertx));
