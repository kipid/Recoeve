...
public class RecoeveDB {
  ...
  public String putBlogStat1(Timestamp tNow, String ip, String uri, String referer, String REACTION_GUEST,
    ...
    try {
      ...
      if (referer == null || referer.isEmpty()
          || refererFromServer != null && refererFromServer.length() > referer.length()) {
