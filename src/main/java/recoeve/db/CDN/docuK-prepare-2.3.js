...
<div class="caption p cmt" style="margin:1em 0 0"><a target="_blank" href="https://recoeve.net/user/kipid?cat=${encodeURIComponent(m.recoCat)}&ToR=#headPlay">${m.escapeOnlyTag(m.recoCat)} of kipid's Recoeve.net</a>
<div class="rC recoeve"><div class="rSC">
	<iframe delayed-src="https://recoeve.net/user/kipid?cat=${encodeURIComponent(m.recoCat)}&ToR=#headPlay" frameborder="0"></iframe>
</div></div></div>
</div>`;
	};
