...
cd C:/Codeit-FS2/2-Sprint-Mission-FE
git remote set-url origin https://kipid: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@github.com/kipid/2-Sprint-Mission-FE.git
git pull

cd C:/Codeit-FS2/2-Sprint-Mission-BE
