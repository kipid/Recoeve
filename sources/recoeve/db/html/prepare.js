...
ptnURI.toIframe=function (uriRest, inListPlay) {
	...
	if (exec!==null) {
		return {html:m.rC(`<div class="center"><iframe delayed-src="https://www.instagram.com/p/${exec[1]}/embed" frameborder="0" scrolling="no" allowtransparency="true"></iframe></div>`, null, null, true), from:"insta", imgId:exec[1]};
	}
	return false;
};
...
ptnURI.toIframe=function (uriRest, inListPlay) {
	...
	if (exec!==null) {
		return {html:m.rC(`<div class="center"><iframe class="tiktok" delayed-src="https://www.tiktok.com/embed/v2/${exec[2]}" sandbox="allow-popups allow-popups-to-escape-sandbox allow-scripts allow-top-navigation allow-same-origin" frameborder='no' scrolling='no' marginwidth='0' marginheight='0' allowfullscreen></iframe></div>`, null, null, true), from:"tiktok", userId:exec[1], videoId:exec[2]};
	}
	return false;
};
