...
SET CLASSPATH=.;%CLASSPATH%;%RECOEVE_HOME%\build\classes\java\main;%RECOEVE_HOME%\build\libs\http-1.0.0-SNAPSHOT-fat.jar;%RECOEVE_HOME%\gradle\wrapper\gradle-wrapper.jar;%JAVA_HOME%\lib
